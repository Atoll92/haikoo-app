...
const Haikoo = () => {
    ...
    function displayInventaire(inventaire) {
        ...
        var str = '<div className="letlist">';
        var lettersnum = inventaire.length;

        inventaire.forEach(function (letter) {
            str += '<h1 className="letter ' + (letter.used ? 'used' : 'notused') + '">' + letter.value + '</h1>';
        });
    ...
    //         str += '<h1 className="letter">' + letter + '</h1>';
    //     });
